...
thumbnail: "/images/posts/80d07745-979e-4052-9445-2a83acc64424.png"
date: "2025-06-22"
tags: ["tutorial"]
---
...
1. 建立新的 Integration
	...
	![image.png](/images/posts/96d3987f-1ecf-4112-a41f-196843815b73.png)
...
2. 開啟權限
	...
	![image.png](/images/posts/49a3bc1e-7e4e-4ac3-9e11-3238bbe24de2.png)
...
3. 複製 Notion token
	...
	![image.png](/images/posts/ba57fef2-d1e8-4c83-ad1e-cbfc36c55db2.png)
...
4. 加入資料庫連線
	...
	![image.png](/images/posts/94955a9e-6d5d-499d-af13-d5e37b0bcfb7.png)


	![image.png](/images/posts/a37edba1-1683-4685-b8d5-c5456c6e95b4.png)
...
5. 複製資料庫 ID
	...
	![image.png](/images/posts/23e8dd36-09b4-4db9-82ec-600c5289f2a1.png)
...
1. Fork 專案
	...
	![image.png](/images/posts/f57f6bb2-d509-4963-8154-fb17f318de09.png)
...
2. 設定 GitHub Secrets / Notion Token
	...
	![image.png](/images/posts/bec92a05-d98c-49b5-af65-5801e78548df.png)


	![image.png](/images/posts/da34dc07-1cd5-431c-9fdf-a062623d8669.png)


	新增一個名稱為 `NOTION_TOKEN` 的 Secret，值為剛剛複製的 Notion Integration Token。


	![image.png](/images/posts/5ee01a54-d226-4381-b12e-1b69f6777157.png)


	再新增一個 Secret 名稱為 `NOTION_DATABASE_ID`，值為你剛剛記下的資料庫 ID。


	![image.png](/images/posts/2df781e3-59c9-4c48-a3bb-fad99bdad1f5.png)
...
![image.png](/images/posts/e418c7ca-0d76-48bd-aa9c-f36fcf394d81.png)


![image.png](/images/posts/e23da4cb-ff26-432e-a919-cf06ceb91f56.png)


按下 **Deploy** 即可部署，幾秒鐘後你的部落格就會正式上線！


![image.png](/images/posts/f8faffee-afad-48c5-9073-9ee18627088b.png)
