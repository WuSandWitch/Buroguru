...
thumbnail: "/images/posts/cef875d2-cedb-487e-bf45-123ffd24b932.png"
date: "2025-06-22"
tags: ["tutorial"]
---
...
1. 建立新的 Integration
	...
	![image.png](/images/posts/6e73f2ce-f81b-44a0-83f4-ecf5deabe7a1.png)
...
2. 開啟權限
	...
	![image.png](/images/posts/d9522a15-b58d-436a-be7f-8968d04ae6bd.png)
...
3. 複製 Notion token
	...
	![image.png](/images/posts/dd7fa3ce-6df7-4606-9fd0-1c6c72340346.png)
...
4. 加入資料庫連線
	...
	![image.png](/images/posts/dd992f98-0fc6-49d4-a45f-ce63f45ff747.png)


	![image.png](/images/posts/1d6e1c2e-d45c-4cc1-8b70-ead86af652e1.png)
...
5. 複製資料庫 ID
	...
	![image.png](/images/posts/57360ae4-73c0-4e8d-98c9-3d3543f965c6.png)
...
1. Fork 專案
	...
	![image.png](/images/posts/143f7a52-ed9e-4773-a0ce-86fa5fb9ff9f.png)
...
2. 設定 GitHub Secrets / Notion Token
	...
	![image.png](/images/posts/507cc3f7-ce9a-4e79-8056-f7a03dd68d42.png)


	![image.png](/images/posts/79a9661d-e2a0-4975-b7f7-b52629e1334d.png)


	新增一個名稱為 `NOTION_TOKEN` 的 Secret，值為剛剛複製的 Notion Integration Token。


	![image.png](/images/posts/a8f9cf74-573f-4186-84bd-da024b9657e5.png)


	再新增一個 Secret 名稱為 `NOTION_DATABASE_ID`，值為你剛剛記下的資料庫 ID。


	![image.png](/images/posts/e6a19769-296b-4214-9512-3b9411cf448c.png)
...
![image.png](/images/posts/2dac1946-e8f6-4465-8a47-0ea6aa208452.png)


![image.png](/images/posts/4f4c0c8a-c1f7-4fa8-9a1e-aba9291fea4d.png)


按下 **Deploy** 即可部署，幾秒鐘後你的部落格就會正式上線！


![image.png](/images/posts/375ed86d-2868-41ac-bcbf-c02716dbc8e6.png)
